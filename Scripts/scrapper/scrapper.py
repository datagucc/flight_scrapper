...
from Scripts.scrapper.utils import launch_browser, handle_cookies_popup, go_to_url,move_mouse_randomly
...
def click_next_page(page: Page):
    ...
    try:
        ...
        page.wait_for_timeout(600 + random.randint(400, 800))
    except Exception as e:
        # Capture screenshot on failure to aid debugging
...
def scrapping_url(
    ...
    log_path = f"{PATH['log_path']}/scrapper/scraping_log_{current_date_full}.csv"
